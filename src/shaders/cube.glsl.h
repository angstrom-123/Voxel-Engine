...
/*
    ...
    =========
    Shader program: 'cube':
        Get shader desc: cube_cube_shader_desc(sg_query_backend());
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_cube_cube_position => 0
            ATTR_cube_cube_color0 => 1
    Bindings:
...
#endif
#endif
#define ATTR_cube_cube_position (0)
#define ATTR_cube_cube_color0 (1)
...
*/
static const uint8_t cube_vs_source_glsl300es[266] = {
...
*/
static const uint8_t cube_fs_source_glsl300es[175] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
...
static inline const sg_shader_desc* cube_cube_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLES3) {
        static sg_shader_desc desc;
        static bool valid;
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)cube_vs_source_glsl300es;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)cube_fs_source_glsl300es;
