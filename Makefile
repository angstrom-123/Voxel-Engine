...
DEBUG_FLAGS		+= -DDEBUG -DEM_ENABLE_LOGGING -DEM_ALIAS_TYPES -DSOKOL_DEBUG

RELEASE_FLAGS	:= 
RELEASE_FLAGS	+= -O3 -g
RELEASE_FLAGS	+= -DRELEASE -DEM_ALIAS_TYPES

TEST_FLAGS		:=
TEST_FLAGS		+= -g -O0 
TEST_FLAGS		+= -DTEST -DDEBUG -DEM_ALIAS_TYPES -DEM_ENABLE_LOGGING -DSOKOL_DEBUG

PROFILING_FLAGS := 
PROFILING_FLAGS += -O3
PROFILING_FLAGS += -DPROFILING -DEM_ALIAS_TYPES

export MAKE_DIR OBJ_DIR SRC_DIR INC_DIR LIB_DIR BIN_DIR OUTPUT_DIR PREBUILT_DIR CC BEAR C_FLAGS LINK_FLAGS MAIN_FILE RELEASE_FLAGS DEBUG_FLAGS TEST_FLAGS PROFILING_FLAGS PLATFORM
