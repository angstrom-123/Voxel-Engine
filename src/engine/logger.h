...
#if DO_DEBUG
#define ENGINE_LOG_ERROR(fmt, ...) _LOG("ENGINE (error)", COL_ERR, fmt, __VA_ARGS__)
#define ENGINE_LOG_WARN(fmt, ...) _LOG("ENGINE (warn)", COL_WRN, fmt, __VA_ARGS__)
#define ENGINE_LOG_OK(fmt, ...) _LOG("ENGINE (ok)", COL_OKK, fmt, __VA_ARGS__)
...
#define APP_LOG_ERROR(fmt, ...) _LOG("APP (error)", COL_ERR, fmt, __VA_ARGS__)
#define APP_LOG_WARN(fmt, ...) _LOG("APP (warn)", COL_WRN, fmt, __VA_ARGS__)
#define APP_LOG_OK(fmt, ...) _LOG("APP (ok)", COL_OKK, fmt, __VA_ARGS__)
